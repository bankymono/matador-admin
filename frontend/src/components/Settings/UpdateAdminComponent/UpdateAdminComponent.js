...
import './UpdateAdminComponent.css'
        ...
        <div className="create-admin-container">
            ...
            <div className="create-adm-profile-img-wrapper">
                ...
                <div className="create-adm-upload-btn-wrapper">
                    ...
                    <label className="create-adm-upload-btn" htmlFor="create-adm-upload-btn">Change Avatar</label>
                </div>
            </div>
            ...
            <div className="create-adm-form-wrapper">
                ...
                <div className="create-input-item">
                    <div></div>
                    <div className="update-input-btns-wrapper">
                    <button className="update-adm-delete-btn" >Delete Admin Account</button>  
                    <button className="update-adm-discard-btn" >Discard Changes</button>  
